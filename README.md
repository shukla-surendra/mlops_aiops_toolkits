...
| **`agentsexplore/`** | Agentic AI / LLM tooling practice — MCP (from scratch and official SDKs), FastMCP auth patterns, LangGraph + Ollama, vector DBs (FAISS, Qdrant, pgvector), RAG, and Bedrock AgentCore. Has its own MkDocs site. |
...
`cloud-practice`, `k8n_explorer`, `agentsexplore`, and `engineering_notebook`
